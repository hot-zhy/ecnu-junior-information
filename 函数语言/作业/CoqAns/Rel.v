...
Inductive squareP : nat -> nat -> Prop :=
 | sq n : squareP n (n*n).



Theorem squareP_partial : partial_function squareP.
...
Inductive empty_rel' : nat -> nat-> Prop :=
 | ff : forall m n, False -> empty_rel' m n.



Inductive empty_rel : nat -> nat -> Prop := .
Theorem empty_rel_partial :
