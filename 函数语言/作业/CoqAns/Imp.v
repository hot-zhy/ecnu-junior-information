...
Proof. simpl. right. right. right. right. right. right. right. right. right. left. reflexivity.  Qed.
...
Proof.
  intros. lia.
 (* Require Import Coq.omega.Omega. omega. *)
Qed.
...
(* FILL IN HERE *)
  ...
  | E_BEq (a1 a2 : aexp) (n1 n2 : nat) :
      (a1 ==> n1) -> (a2 ==> n2) -> (BEq a1 a2) ==>b (Nat.eqb n1 n2)
  | E_BLe (a1 a2 : aexp) (n1 n2 : nat) :
      (a1 ==> n1) -> (a2 ==> n2) -> (BLe a1 a2) ==>b (leb n1 n2)
  | E_BNot (b : bexp) (bb : bool) :
      (b ==>b bb) -> (BNot b) ==>b negb bb
  | E_BAnd (b1 b2 : bexp) (bb1 bb2 : bool) :
      (b1 ==>b bb1) -> (b2 ==>b bb2) -> (BAnd b1 b2) ==>b (andb bb1 bb2)
